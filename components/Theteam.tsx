...
//             <h2 className="mb-4 text-2xl font-bold text-center text-gray-900 md:text-4xl">GuestInn Management</h2>
...
//                 <img className="object-cover w-64 h-64 mx-auto rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64" 
...
//             </div>
//             <div className="space-y-4 text-center">
//                 <img className="object-cover w-64 h-64 mx-auto rounded-xl md:w-48 md:h-64 lg:w-64 lg:h-80" 
